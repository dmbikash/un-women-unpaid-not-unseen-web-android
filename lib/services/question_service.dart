...
class QuestionService {
  ...
  static List<Question> getQuestions() {
    ...
    // Scoring values for different activities
    const Map<String, int> activityScores = {
      'cooking': 50, // Cooking tasks
      'cleaning':50, // Cleaning the home
      'childcare': 50, // Taking care of children
      'eldercare': 50, // Caring for elderly family members
      'grocery': 50, // Grocery shopping
      ...
      'health_care_support': 50, // Transportation of family members
    ...
    return [
      ...
      Question(
        ...
        pointValue: activityScores['grocery'] ?? 0,
        hourOptions: standardHourOptions,
      ),
      Question(
        id: '5',
